...
# Theme toggle with complete CSS override
theme = st.radio("🌗 Choose Theme", ["Light", "Dark"], horizontal=True)
if theme == "Dark":
    st.markdown("""
    <style>
    html, body, .stApp, .main, .block-container, .css-18e3th9, .css-1d391kg {
        background-color: #0e1117 !important;
        color: white !important;
    }
    header, footer, .css-164nlkn, .css-1v0mbdj {
        background-color: #0e1117 !important;
    }
    ...
    .stDataFrame, .css-1v0mbdj, .css-1cpxqw2 {
