...
if theme == "Dark":
    st.markdown(
        "<style>body{background-color: #0e1117; color: white;} .stTextInput, .stTextArea, .stFileUploader, .stSelectbox, .stDownloadButton, .stButton, .stRadio, .stCheckbox {color: white;}</style>",
